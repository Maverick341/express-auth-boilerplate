...
import { generateNonce, generateState, verifyGoogleToken } from "../utils/authUtils.js";
...
const registerUser = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "User registered successfully. Please verify your email now.");
...
const loginUser = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "Login successful");
...
const verifyEmail = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "User account is verified");
...
const resendVerificationEmail = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "Verification email sent successfully, check your registered email inbox");
...
const forgotPasswordRequest = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "Reset password email sent. Please check your inbox.");
...
const changeCurrentPassword = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "Password changed successfully");
...
const getCurrentUser = asyncHandler(async (req, res) => {
    ...
    const response = new ApiResponse(201, user.toPublicUserJSON(), "Current User Shown");
...
const updateAccountDetails = asyncHandler(async (req, res) => {
    ...
    return res.status(200).json(
        new ApiResponse(200, updatedUser.toPublicUserJSON(), "Account details updated successfully")
    );
});
...
const updateUserAvatar = asyncHandler(async (req, res) => {
    ...
    return res
        .status(200)
        .json(
            new ApiResponse(200, user.toPublicUserJSON(), "Avatar image updated successfully")
        )
});
...
const googleCallback = asyncHandler(async (req, res) => {
    ...
    const { id_token, googleAccessToken, googleRefreshToken } = tokenResponse.data;
    if (!id_token) {
    ...
    if (!user) {
        ...
        const response = new ApiResponse(201, user.toPublicUserJSON(), "Google Login successful");

        return res.status(response.statusCode).json(response);
    }
});

const setGoogleOAuthUsername = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json({ message: "Signup completed", user: user.toPublicUserJSON() });
});
...
const githubCallback = asyncHandler(async (req, res) => {
    ...
    return res.status(201).json(new ApiResponse(201, user.toPublicUserJSON(), "GitHub Login successful"));
});

export { registerUser, loginUser, logoutUser, verifyEmail, resendVerificationEmail, refreshAccessToken, forgotPasswordRequest, changeCurrentPassword, getCurrentUser, updateAccountDetails, updateUserAvatar, googleLogin, googleCallback, setGoogleOAuthUsername, githubLogin, githubCallback };
